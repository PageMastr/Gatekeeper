...
; Agents read stdout. Make sure stdout is worth reading.
...
; The harness presses *actions*, never raw keys, so a rebind never breaks a test.
; Every action a playtest plan references must exist here or the run reports
; `input_action:<name>` as a failure.
move_forward={
"deadzone": 0.2,
...
; Shadow atlas sizing matters more than light count. See references/godot-patterns.md.
lights_and_shadows/directional_shadow/size=4096
lights_and_shadows/positional_shadow/atlas_size=4096
anti_aliasing/quality/msaa_3d=2
environment/defaults/default_clear_color=Color(0.02, 0.025, 0.04, 1)
